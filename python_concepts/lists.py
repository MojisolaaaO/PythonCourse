...
# if you want to remove the last item but do not know the length of thr list, use negative indexing
fruits.pop(-1)
print(fruits)
...
# the "index" function allows us to check the membership and index function of an item in a list
