...
"""
Conditions are statement that allows us to make decisions within our code based on a given set of conditions
...
else statement closes out the if, elif, else code block and contains anything the user might not do 
"""
