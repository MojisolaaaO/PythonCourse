...
Provides the Command class, the base class for the command classes.py
...
class Command:
    """Abstract base class for defining command classes.py, the "worker bees"
    of the Distutils.  A useful analogy for command classes.py is to think of
    ...
    def __init__(self, dist):
        ...
        instantiated.
        """
        # late import because of mutual dependence between these classes.py
    ...
    def initialize_options(self):
        ...
        This method must be implemented by all command classes.py.
        """
        raise RuntimeError(
    ...
    # classes.py need do nothing more than (eg.)
