...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # for the setup script to override command classes.py
        self.cmdclass = {}
    ...
    def parse_command_line(self):
        ...
        command class -- thus, we have to be able to load command classes.py
...
def fix_help_options(options):
    ...
    classes.py to the 3-tuple form required by FancyGetopt.
    """
    new_options = []
