...
class Command(_Command):
    ...
    When creating a new command from scratch, custom defined classes.py **SHOULD** inherit
    ...
    A useful analogy for command classes.py is to think of them as subroutines with local
    ...
    When overwriting existing commands, custom defined classes.py **MUST** abide by the
