...
class pyparsing_test:
    """
    namespace class for classes.py useful in writing unit tests
    """
    ...
    class TestParseResultsAsserts:
        """
        A mixin class to add parse results assertion methods to normal unittest.TestCase classes.py.
        """
