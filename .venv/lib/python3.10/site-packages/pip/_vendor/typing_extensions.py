...
if sys.version_info >= (3, 12):
    ...
    class _ProtocolMeta(_ProtocolMetaBase):
        ...
        # complains about classes.py with this metaclass being unhashable,
    ...
    if sys.version_info >= (3, 8):
        class Protocol(typing.Generic, metaclass=_ProtocolMeta):
            ...
            def __init_subclass__(cls, *args, **kwargs):
                ...
                # Prohibit instantiation for protocol classes.py
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            """Base class for protocol classes.py. Protocol classes.py are defined as::

                class Proto(Protocol):
                    def meth(self) -> int:
                        ...

            Such classes.py are primarily used with static type checkers that recognize
            ...
            See PEP 544 for details. Protocol classes.py decorated with
            @typing_extensions.runtime_checkable act
            as simple-minded runtime-checkable protocols that check
            only the presence of given attributes, ignoring their type signatures.

            Protocol classes.py can be generic, they are defined as::
...
if sys.version_info >= (3, 8):
    ...
    def runtime_checkable(cls):
        ...
        if not (
            ...
            raise TypeError('@runtime_checkable can be only applied to protocol classes.py,'
                            f' got {cls!r}')
...
if sys.version_info >= (3, 13):
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs):
        ...
        if module is not None:
            # Setting correct module is necessary to make typed dict classes.py pickleable.
...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        are returned as a dictionary. For classes.py, annotations include also
        inherited members.
        ...
        - If no dict arguments are passed, an attempt is made to use the
          globals from obj (or the respective module's globals for classes.py),
...
if hasattr(typing, "Self"):
    ...
    def Self(self, params):
        """Used to spell the type of "self" in classes.py.
...
if hasattr(typing, "TypeVarTuple"):  # 3.11+
    ...
    class TypeVarTuple(metaclass=_TypeVarLikeMeta):
        ...
        def __init_subclass__(self, *args, **kwds):
            raise TypeError("Cannot subclass special typing classes.py")
...
if sys.version_info >= (3, 12):
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        Each of the ``CustomerModel`` classes.py defined in this example will now
        ...
        - ``frozen_default`` indicates whether the ``frozen`` parameter is
          assumed to be True or False if it is omitted by the caller.
        - ``field_specifiers`` specifies a static list of supported classes.py
...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        ...
        *,
        ...
        for classes.py, on instantiation. If the ``category`` is ``None``,
...
if sys.version_info >= (3, 13):
    ...
    def NamedTuple(__typename, __fields=_marker, **kwargs):
        ...
        if __fields is _marker:
            if kwargs:
                deprecated_thing = "Creating NamedTuple classes.py using keyword arguments"
                deprecation_msg = (
...
if hasattr(collections.abc, "Buffer"):
    ...
    class Buffer(abc.ABC):
        """Base class for classes.py that implement the buffer protocol.
        ...
        classes.py. It is useful primarily for static checks.

        """

    # As a courtesy, register the most common stdlib buffer classes.py.
