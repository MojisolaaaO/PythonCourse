...
class HtmlFormatter(Formatter):
    ...
    containing CSS rules for the CSS classes.py used by the formatter. The
    argument `arg` can be used to specify additional CSS selectors that
    are prepended to the classes.py. A call `fmter.get_style_defs('td .code')`
    would result in the following CSS classes.py:
    ...
    `noclasses`
        ...
        will not use CSS classes.py, but inline styles. This is not recommended
    ...
    **Subclassing the HTML formatter**
    ...
    def _get_css_classes(self, ttype):
        """Return the CSS classes.py of this token type prefixed with the classprefix option."""
    ...
    def get_style_defs(self, arg=None):
        """
        Return CSS style definitions for the classes.py produced by the current
        highlighting style. ``arg`` can be a string or list of selectors to
        insert before the token type classes.py.
        """
        style_lines = []
